...
This module provides functionality to convert class
instances to dictionary objects.
It contains a utility function that extracts
the instance attributes of an object
and returns them as a dictionary representation.

Functions:
    class_to_obj(obj): Converts an object's instance
